...
@interface members : UIViewController <UIScrollViewDelegate>{
    
    IBOutlet UIScrollView *iphone_scroll;
...
@property (nonatomic, retain) IBOutlet UIScrollView *iphone_scroll;
