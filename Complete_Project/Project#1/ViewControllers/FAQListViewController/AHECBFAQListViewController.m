...
@interface AHECBFAQListViewController (Private)
- (void)updateItems:(id)sender;
- (void)updateFAQView:(NSNotification*)notification;
@end

@implementation AHECBFAQListViewController
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    AHEBCFAQDetailsViewController* detailsViewController = [[AHEBCFAQDetailsViewController alloc] initWithNibName:[[self class] defaultTableViewControllerNibName] bundle:[NSBundle mainBundle] question:question];
...
- (IBAction)askQuestion:(id)sender
{
    ...
    {
        NSString* titleError =  @"الرجاء ادخال السؤال";
        NSString* messageError = @"الرجاء إدخال السؤال";
