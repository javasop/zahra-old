...
//            app.cartArray = [[NSMutableArray alloc]init];
            ...
            if ([strExpired isEqualToString:@"1"]) {
                UIAlertView *alertExpired= [[UIAlertView alloc] initWithTitle:@"Store Module" message:@"Code can not be applied." delegate:self cancelButtonTitle:nil otherButtonTitles:@"OK", nil];
                [alertExpired show];
            ...
            else if([strExpired isEqualToString:@"0"])
            {
                ...
                if ([strPrecentage isEqualToString:@"0"])
                {
                        ...
                        NSString *msg=[NSString stringWithFormat:@"You have got %.2f %% discount.",discountValue];
                        UIAlertView *alertDis= [[UIAlertView alloc] initWithTitle:@"Store Module" message:msg delegate:self cancelButtonTitle:nil otherButtonTitles:@"OK", nil];
                        [alertDis show];
                        alertDis.tag=2;
                        [alertDis release];
                }
                else if([strPrecentage isEqualToString:@"1"])
                {
                        ...
                        app.costInfo=totalLable.text;
                        NSString *msg=[NSString stringWithFormat:@"You have got $ %.2f discount.",discountValue];
                        UIAlertView *alertDis1= [[UIAlertView alloc] initWithTitle:@"Store Module" message:msg delegate:self cancelButtonTitle:nil otherButtonTitles:@"OK", nil];
                        [alertDis1 show];
                        alertDis1.tag=3;
                        [alertDis1 release];
                }
    ...
    {
        UIAlertView *alertMsg= [[UIAlertView alloc] initWithTitle:@"Store Module" message:@"Cart List is Empty. Please add product to cart." delegate:self cancelButtonTitle:nil otherButtonTitles:@"OK", nil];
        [alertMsg show];
        [alertMsg release];
    }
