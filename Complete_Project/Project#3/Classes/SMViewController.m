...
- (void)viewDidLoad
{
    ...
    NSString *strurl = [NSString stringWithFormat:@"http://www.galamr.com/services/index.php/welcome/products_list_lz_json"];
...
-(IBAction)coverFlowView:(id)sender{
    ...
    CoverFlowViewController *coverView=[[CoverFlowViewController alloc] initWithNibName:@"CoverFlowViewController" bundle:nil];
