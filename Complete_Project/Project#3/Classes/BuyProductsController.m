...
#import "SBJson.h"
@implementation BuyProductsController
...
-(BOOL)validate{
    NSString *store_title = @"متجر لمسة زهرة";
    ...
    {
        UIAlertView *alertFname = [[UIAlertView alloc]initWithTitle:store_title message:@"الاسم الأول مطلوب" delegate:self cancelButtonTitle:nil otherButtonTitles:@"موافق", nil];
    ...
    {
        UIAlertView *alertLname = [[UIAlertView alloc]initWithTitle:store_title message:@"الاسم الأخير مطلوب" delegate:self cancelButtonTitle:nil otherButtonTitles:@"موافق", nil];
        [alertLname show];
        [alertLname release];
        return NO;
    }
    ...
    {
        UIAlertView *alertEmail = [[UIAlertView alloc]initWithTitle:store_title message:@"الرجاء التأكد من عنوان البريد الالكتروني" delegate:self cancelButtonTitle:nil otherButtonTitles:@"موافق", nil];
        [alertEmail show];
        [alertEmail release];
        return NO;
    }
    ...
    {
        UIAlertView *alertPhn = [[UIAlertView alloc]initWithTitle:store_title message:@"الرجاء التأكد من إدخال رقم الهاتف" delegate:self cancelButtonTitle:nil otherButtonTitles:@"موافق", nil];
        [alertPhn show];
        [alertPhn release];
        return NO;
        ...
        UIAlertView *alertPhn = [[UIAlertView alloc]initWithTitle:store_title message:@"الرجاء التأكد من إدخال العنوان" delegate:self cancelButtonTitle:nil otherButtonTitles:@"موافق", nil];
        [alertPhn show];
        [alertPhn release];
        return NO;
        ...
        UIAlertView *alertPhn = [[UIAlertView alloc]initWithTitle:store_title message:@"الرجاء التأكد من إدخال المنطقة" delegate:self cancelButtonTitle:nil otherButtonTitles:@"موافق", nil];
        [alertPhn show];
        [alertPhn release];
        return NO;
        ...
        UIAlertView *alertPhn = [[UIAlertView alloc]initWithTitle:store_title message:@"الرجاء التأكد من إدخال المدينة" delegate:self cancelButtonTitle:nil otherButtonTitles:@"موافق", nil];
        [alertPhn show];
        [alertPhn release];
        return NO;
        
    }else if ([district_string length] <= 0) {
        UIAlertView *alertPhn = [[UIAlertView alloc]initWithTitle:store_title message:@"الرجاء التأكد من إدخال الحي" delegate:self cancelButtonTitle:nil otherButtonTitles:@"موافق", nil];
        [alertPhn show];
        [alertPhn release];
        return NO;
    }
...
-(IBAction)completeOrder:(id)sender{
    ...
    [dictOrder setObject:app.addressInfo forKey:@"address"];
        //[dictOrder setObject:@"region" forKey:@"region"];
    ...
    // check the dict order .. 
    // test the values
    
/*    
    NSArray *kz = [dictOrder allKeys];
    for (int i = 0; i < [kz count]; i++) {
        NSString *str = [dictOrder objectForKey:[kz objectAtIndex:i]];
        if ([str length] <= 0) {
