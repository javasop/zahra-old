...
@implementation HLBCArticleDetailsViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (cell == nil)
    {
        self.newsTableViewCell = [[[HLBCArticleDetailsTableViewCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:CellNewsIdentifier] autorelease];
    ...
    ((HLBCArticleDetailsTableViewCell*)cell).titleLabel.text = self.artcle.title;
    ((HLBCArticleDetailsTableViewCell*)cell).detailInfoTextField.text = self.artcle.abstract;
    ((HLBCArticleDetailsTableViewCell*)cell).fullDescriptionTextView.text = self.artcle.text;
    ((HLBCArticleDetailsTableViewCell*)cell).dateLabel.text = [MTSAbstractJSONModelClass dayMonthTimeStringFromDate:self.artcle.date];
    
    ((HLBCArticleDetailsTableViewCell*)cell).sourceTextField.text = [NSString stringWithFormat:@"%@ %@",self.artcle.author.firstname, self.artcle.author.lastname];
