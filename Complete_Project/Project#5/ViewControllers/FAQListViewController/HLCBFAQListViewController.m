...
@interface HLCBFAQListViewController (Private)
- (void)updateItems:(id)sender;
- (void)updateFAQView:(NSNotification*)notification;
@end

@implementation HLCBFAQListViewController
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    HLBCFAQDetailsViewController* detailsViewController = [[HLBCFAQDetailsViewController alloc] initWithNibName:[[self class] defaultTableViewControllerNibName] bundle:[NSBundle mainBundle] question:question];
