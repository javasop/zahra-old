...
@implementation HEBCFAQDetailsViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (cell == nil)
    {
        self.newsTableViewCell = [[[HEBCArticleDetailsTableViewCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:CellFAQDetailsIdentifier] autorelease];
    ...
    ((HEBCArticleDetailsTableViewCell*)cell).titleLabel.text = self.question.question;
    ((HEBCArticleDetailsTableViewCell*)cell).fullDescriptionTextView.text = self.question.content;
    ((HEBCArticleDetailsTableViewCell*)cell).dateLabel.text = [MTSAbstractJSONModelClass dayMonthTimeStringFromDate:self.question.date];
