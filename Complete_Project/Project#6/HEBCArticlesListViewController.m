...
@interface HEBCArticlesListViewController (Private)
- (void)updateItems:(id)sender;
- (void)updateArticleView:(NSNotification*)notification;
@end

@implementation HEBCArticlesListViewController
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    HEBCArticleDetailsViewController* detailsViewController = [[HEBCArticleDetailsViewController alloc] initWithNibName:[[self class] defaultTableViewControllerNibName] bundle:[NSBundle mainBundle] article:article];
