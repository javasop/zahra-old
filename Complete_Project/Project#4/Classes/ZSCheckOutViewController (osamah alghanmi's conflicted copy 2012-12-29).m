...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (app.device==0) {
        ...
        cell.itemtotalLbl.text = [NSString stringWithFormat:@"Total : %.2f $",(([[qtyArr objectAtIndex:indexPath.row]floatValue])*([[[app.cartArray objectAtIndex:indexPath.row] objectForKey:@"product_price"] floatValue]))];
    ...
    cell.itempriceLbl.text=[NSString stringWithFormat:@"Item Price : %@ $",[[app.cartArray objectAtIndex:indexPath.row] objectForKey:@"product_price"]];
