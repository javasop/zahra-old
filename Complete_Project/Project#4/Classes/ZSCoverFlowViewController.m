...
@implementation ZSCoverFlowViewController
...
-(id)initWithNibName:(NSString *)nibNameOrNil bundle:(NSBundle *)nibBundleOrNil
{
    ...
    if (self) {         
        ...
        objpop = [[ZSCartPopOverViewController alloc]initWithNibName:@"ZSCartPopOverViewController" bundle:nil];
        objpop.cartObj = self;
    }
    return self;
}
...
-(void)checkoutDone
{
    if ([app.cartArray count]>0) {
        ...
        ZSCheckOutViewController *obj = [[ZSCheckOutViewController alloc]initWithNibName:@"ZSCheckOutViewController" bundle:nil];
...
-(IBAction)AddToCart:(id)sender{
    if (app.device == 0) {
        ZSCartPopOverViewController* content = [[ZSCartPopOverViewController alloc] initWithNibName:@"ZSCartPopOverViewControllerPre" bundle:nil];
        ...
        if ([popoverController isPopoverVisible]) {
            ...
            ZSCartPopOverViewController* content = [[ZSCartPopOverViewController alloc] init];
...
-(void)willAnimateRotationToInterfaceOrientation:(UIInterfaceOrientation)toInterfaceOrientation duration:(NSTimeInterval)duration
{
        if (toInterfaceOrientation==UIInterfaceOrientationPortrait || toInterfaceOrientation==UIInterfaceOrientationPortraitUpsideDown) {
            ...
            prdDesc.frame=CGRectMake(156, 681, 159, 35);
            //ProductDesc.frame=CGRectMake(323, 668, 289, 72);
            //saddCart.frame=CGRectMake(280, 765, 208, 57);
        }
        else
        {
            carousel.frame=CGRectMake(0, 0, 1024, 400);
