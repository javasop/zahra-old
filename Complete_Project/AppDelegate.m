...
@synthesize bookLibArray;



//Project #3
@synthesize mainArray,buttonSelected,cartArray,lat,lon,region,locationManager,device,orderArray,productsArray;
@synthesize fnameInfo,lnameInfo,emailInfo,phnInfo,addInfo,costInfo,paymentInfo,addressInfo;
@synthesize region_string,district_string, city_string;
...
{ 
    ...
    if ([reachability currentReachabilityStatus]  ==  NotReachable)
    {
        ...
        NSString *arabic_err = @"لا يوجد اتصال بالشبكة";
        UIAlertView* alertView = [[UIAlertView alloc] initWithTitle:@"تنبيه"
                                                            message:arabic_err 
                                                           delegate:nil 
