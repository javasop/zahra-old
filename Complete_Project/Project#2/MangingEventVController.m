...
//        [formatter setTimeZone:[NSTimeZone timeZoneWithName:@"EST"]];
        ...
        for (id myArrayElement in data) {
            
            NSString *element = myArrayElement;
            
            NSDate *convd = [formatter dateFromString:element];
            
            NSComparisonResult compare = [convd compare:d];

            if(compare == NSOrderedSame){
                
                //means the date falls within the correct range
                decision = YES;
