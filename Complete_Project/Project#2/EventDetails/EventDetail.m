...
- (void)viewDidLoad
{
    ...
    barBtn = [[UIBarButtonItem alloc] initWithTitle:@"حجز" style:UIBarButtonItemStylePlain target:self action:@selector(booking:)];
    ...
    if (thedelegate.isNetworkAvailable)
    {
        ...
        if (carouselCheck == 1)
        {
            ...
            if ([imgArray count] > 0){
                ...
                NSLog(@"Image Array Count: %i", [imgArray count]);
            ...
            if ([[UIDevice currentDevice] userInterfaceIdiom] == UIUserInterfaceIdiomPhone){ 
                ...
                //carousel = [[iCarousel alloc] initWithFrame:CGRectMake(-100, -110, 50, 50)];
...
- (IBAction)fullScreen:(id)sender
{
    ...
    modal.navigationController.navigationBar.backgroundColor = [UIColor blackColor];
...
- (UIView *)carousel:(iCarousel *)_carousel viewForItemAtIndex:(NSUInteger)index
{
    if ([[UIDevice currentDevice] userInterfaceIdiom] == UIUserInterfaceIdiomPad) 
    {
        ...
        imageView.frame = CGRectMake(0, 0, 350, 350);
        return imageView;
    }
    else
    {
