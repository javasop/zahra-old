...
- (void)viewDidLoad
{
    ...
    UIBarButtonItem *barBtn = [[UIBarButtonItem alloc] initWithTitle:@"حجز" style:UIBarButtonItemStylePlain target:self action:@selector(submit:)];
    ...
    if(thedelegate.isNetworkAvailable)
    {
      ...
      /*  
       ...
       // NSLog(@"ticket price :%@",[[thedelegate.ticketInfoArray objectAtIndex:thedelegate.ticketSelected] objectForKey:@"ticket_price"]);
        ...
        UIAlertView *alert = [[UIAlertView alloc] initWithTitle:@"تم إرسال الطلب" message:@"سيتم التواصل معكم قريبا" delegate:self cancelButtonTitle:@"موافق" otherButtonTitles:nil, nil];
        [alert show];
...
-(BOOL)textFieldShouldBeginEditing:(UITextField *)textField{
    ...
    if ([[UIDevice currentDevice] userInterfaceIdiom] == UIUserInterfaceIdiomPhone) {
        if (textField != firstNameTxtFld & textField !=secondNameTxtFld & textField != emailTxtFld) {
