...
@synthesize fn,sn,tn,ln,account,issue_city,date_of_issue,dob,mobile,email,type,sub_type,large_bright,large_dim,small_dim,small_bright,vc,amount;
...
//
        ...
        BOOL dec = [emailTest evaluateWithObject:[email text]];
    if(dec == 0){
        
        UIAlertView *alrt = [[UIAlertView alloc] initWithTitle:@"خطأ" message:@"الرجاء ادخال الايميل بالطريقة الصحيحة" delegate:nil cancelButtonTitle:@"موافق" otherButtonTitles:nil];
        [alrt show];
        return;
...
-(BOOL)textFieldShouldBeginEditing:(UITextField *)textField{
    ...
    if (textField != fn & textField !=sn & textField != tn & textField != ln ) {
            [UIView beginAnimations:nil context:NULL];
    ...
    else if(textField == fn || textField ==sn || textField == tn || textField == ln ){
...
- (IBAction)indexChanged:(id)sender {
    ...
    int i = [type selectedSegmentIndex];
    
    switch (i) {
        case 0:
            amount.text = @"١٠٠,٠٠٠ ريال";
            break;
        case 1:
            amount.text = @"٧٥,٠٠٠ ريال";
            break;
        case 2:
            amount.text = @"٥٠,٠٠٠ ريال";
            break;
        case 3:
            amount.text = @"٢٥,٠٠٠ ريال";
            break;
        case 4:
            amount.text = @"١٠٠٠ ريال";
            break;
        case 5:
            amount.text = @"٥٠٠ ريال";
            break;
        case 6:
            amount.text = @"٢٥٠ ريال";
            break;
        default:
            break;
    }
    ...
    //do nothing here?
    NSString *selected = [type titleForSegmentAtIndex:type.selectedSegmentIndex];
